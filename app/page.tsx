          ...
          <div className="flex justify-center items-center min-h-[500px]">
            ...
            <div className="max-w-3xl mx-auto px-4 w-full pb-56 md:pb-0">
              ...
              <div className="fixed bottom-0 left-0 w-full flex justify-center p-4 md:static md:w-auto md:p-0 z-20">
                <Link
                  href="https://api.whatsapp.com/send?phone=59177024774&text=Hola%20%F0%9F%91%8B%2C%20quiero%20m%C3%A1s%20informaci%C3%B3n%20para%20ser%20parte%20del%20programa%20Bienestar%20%F0%9F%A6%9C%20de%20Laboratorios%20Bag%C3%B3%20%F0%9F%92%8A"
                  className="block"
                  target="_blank"
